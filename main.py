...
def section_report():
    ...
    if st.button(tr("generate_pdf")):
        ...
        if pdf_bytes:
            ...
            st.markdown(f"<iframe src='data:application/pdf;base64,{b64}' width='100%' height='800px' type='application/pdf' style='overflow: auto; width: 100%; height: 100%;'></iframe>", unsafe_allow_html=True)
