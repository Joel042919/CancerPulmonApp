...
def load_models():
    ...
    #ResNet50 3D + Attention (SE/CBAM)
    hyb = ResNet50SE().to(device)
    models['3D ResNet50 SE'] = hyb

    #DenseNet121 3D + Autoencoder de características
    models['3D DenseNet121 AE'] = DenseNet121AE().to(device)
